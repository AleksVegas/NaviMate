window.translations = {
  ru: {
    ...
    calcBtn: "Рассчитать",
    clearBtn: "Очистить",  
    errorSpeed: "⚠️ Скорость судов должна быть от 0.1 до 70 км/ч.",
    ...
    timeToMeeting: "⏱️ Время до встречи (ч):",
    ...
    workHours: "Длительность рабочего дня:",
    ...
    forecastNight: "Ночь",
    wind: "💨 Ветер:",
    windSpeedLabel: "Скорость:",
    windGustLabel: "Порывы:",
    humidity: "💧 Влажность:",
    ...
    gpsTimeoutError: "Превышено время ожидания GPS. Попробуйте еще раз.",
    ...
    dayModeEnd: "Конец смены:",
    preset1206: "06:00–18:00",
  ...
  en: {
    ...
    calcBtn: "Calculate",
    clearBtn: "Clear",
    errorSpeed: "⚠️ Vessel speed must be between 0.1 and 70 km/h.",
    ...
    timeToMeeting: "⏱️ Time to meeting (h):",
...
// --- Hours ---
    ...
    gpsPermissionError: "Failed to determine location. Check internet connection.",
    gpsTimeoutError: "GPS timeout exceeded. Try again.",
...
function updateMeetingBlocks() {
  ...
  document.querySelectorAll('.block').forEach((block, index) => {
    ...
    if (btnCopySpeed) btnCopySpeed.innerText = t.copySpeed || "Скопировать скорость из 1 блока";
    ...
    if (calcBtn) calcBtn.innerText = t.calcBtn || "Рассчитать";
